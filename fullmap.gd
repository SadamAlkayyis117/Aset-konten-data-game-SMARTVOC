...
# ======================================================
const BUILDING_ICON_SCENE = preload("res://building_icon.tscn")

const BUILDING_LOCATIONS = [
    { "position": Vector3(31.2, 0.0, 43.8), "texture": preload("res://Taman.png") },
    { "position": Vector3(-217.2, 0.0, 233.4), "texture": preload("res://Sekolah.png") },
    { "position": Vector3(10.8, 0.0, -213.0), "texture": preload("res://mall.png") },
    { "position": Vector3(144.0, 0.0, -63.0), "texture": preload("res://Tempat bensin.png") },
    { "position": Vector3(246.0, 0.0, -155.4), "texture": preload("res://kantor pemadam.png") },
    { "position": Vector3(232.8, 0.0, -69.0), "texture": preload("res://perpustakaan.png") },
    { "position": Vector3(187.2, 0.0, 13.8), "texture": preload("res://bank.png") },
    { "position": Vector3(207.6, 0.0, 111.0), "texture": preload("res://apartemen.png") },
    { "position": Vector3(-187.2, 0.0, 36.6), "texture": preload("res://apartemen.png") },
    { "position": Vector3(-71.99999, 0.0, 21.0), "texture": preload("res://kantor polisi.png") },
    { "position": Vector3(43.2, 0.0, 245.4), "texture": preload("res://Rumah.png") },
    { "position": Vector3(-73.2, 0.0, 76.2), "texture": preload("res://kantor walikota.png") },
    { "position": Vector3(141.6, 0.0, -159.0), "texture": preload("res://Kolam Renang.png") },
    { "position": Vector3(57.6, 0.0, -58.2), "texture": preload("res://Pasar.png") }
]
# ======================================================
...
func open_fullmap():
    ...
    if is_instance_valid(player):
        player.set_input_locked(true, true)
...
func _input(event: InputEvent) -> void:
    ...
    if event is InputEventMouseButton and event.pressed and event.button_index == MOUSE_BUTTON_LEFT:
        ...
        var click_from_center = click_pos_local - map_center_2d
        
        var world_x = click_from_center.x * MAP_SCALE
        var world_z = click_from_center.y * MAP_SCALE
        
        if IS_Z_FLIPPED:
            world_z = -world_z
        
        var world_origin = world.global_position
        var ray_x = world_origin.x + world_x
        var ray_z = world_origin.z + world_z
        
        var from := Vector3(ray_x, 1000.0, ray_z)
        var to := Vector3(ray_x, -100.0, ray_z)
