...
@export var target_scene_path: String ="res://Interior_Sekolah.tscn"
...
@export var target_spawn_point_name: String = "Entrance_Door_Out"

func _on_entrance_sekolah_trigger_body_entered(body: Node3D):
