...
@export var archery_scene: String = "res://archery_map.tscn"
...
@export var mission_id : String = "archery_training"
@export var intro_2_dialog_id : String = "archery_intro_2"
@export var final_dialog_id : String = "archery_final"
@export var gameplay_scene : String = "res://archery_map.tscn"

func _ready():
    interact_area.body_entered.connect(_enter)
    interact_area.body_exited.connect(_exit)
    ArcheryMissionController.mission_started.connect(_on_mission_started)
    ArcheryMissionController.mission_finished.connect(_on_mission_finished)
...
func load_archery_scene():
    get_tree().change_scene_to_file(archery_scene)
